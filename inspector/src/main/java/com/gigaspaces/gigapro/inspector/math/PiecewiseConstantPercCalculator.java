 ...
 *
 */
public class PiecewiseConstantPercCalculator implements PercentileCalculator {
    ...
    private <T extends Number> Double calculateSorted(List<? extends T> sortedData, float percentileRatio) {
        ...
        if (zoneIndex == 0) {
            ...
            double percentile = origin + zoneDelta * multiplier;
            return percentile;
            ...
            double percentile = lastItem + zoneDelta * multiplier;
            return percentile;
            ...
            double percentile = leftItem + zoneDelta * multiplier;
            return percentile;
        } else {
