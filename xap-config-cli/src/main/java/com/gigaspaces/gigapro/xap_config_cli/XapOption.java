...
public enum XapOption {
    ...
    LOOKUP_GROUPS("g", "lookup-groups", "A comma separated list of group names used for multicast lookup discovery", 1, String.class),
    ...
    MULTICAST_DISCOVERY_PORT("d", "multicast-discoveryPort", "The port used during discovery for multicast requests, e.g. 224.0.1.187", 1, Long.class),
    ...
    public <T> Optional<T> getValue(CommandLine commandLine) {
        return XapOptionUtils.getParsedValue(getShortOption(), commandLine);
    }
}
